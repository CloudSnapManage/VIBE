  ...
  return (
    <form onSubmit={handleSearch} className="w-full max-w-lg flex items-center space-x-2">
      <Input
        ...
        className="h-10 text-sm bg-input border-input focus-visible:ring-primary flex-grow"
        aria-label="Web search"
      />
      <Button type="submit" size="default" className="h-10 bg-primary hover:bg-primary/90 text-primary-foreground px-4">
